...
url: "https://doi.org/10.1184/R1/13522718"
language: "en"
abstract: |
  A planning document outlining the structure, mission, and operations of
...
source_pdf: "Weingart_and_Lincoln_-_2021_-_CMU_Library_Labs__2020-2024_.pdf"
source_pdf_sha256: "415516a0917061f4efba49a944e9657130aa47b950f34b8affaa44ca95eccf5a"
page_count: 27
extraction_date: "2026-05-15"
extraction_tool: "claude scholarly-pdf-to-markdown skill"
extraction_notes: |
  Digital-native PDF produced via "Print to PDF" from a single-column word
  processor document. Running header "CMU Library Labs (Weingart & Lincoln)"
  and page numbers at the top of every page after the first have been
  stripped; page numbers are preserved as HTML-comment anchors after each
  page boundary. A multi-page table of contents on pages 1-2 is reproduced
  verbatim. The project-timeline figure on page 7 is extracted to
  images/fig-001-project-timeline.png. The four-criterion proposal
  evaluation rubric (page 13-14) is rendered as a Markdown table.
  Footnotes (numbered 1-4) are converted to Markdown footnote syntax and
